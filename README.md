...
皮肤运行时提供 **3 个预设**，入口在：设置 → General（CHRONO ARCHIVE 行）：

| 预设 | 侧栏 | 壁纸强度 | 适用 |
| --- | --- | --- | --- |
| 黑金 · Chrono Gold（默认） | 黑金档案柜（浅/深外观均生效） | 清晰 | 当前推荐观感 |
| 暖纸 · Warm Archive | 暖纸半透明 | 适中 | 更轻的档案感 |
| 安静 · Quiet | 暖纸半透明 | 淡而柔（blur 4px） | 专注阅读 |

- 切换立即生效，无需重载插件；卸载插件即恢复 DSH 默认外观。
- 黑金侧栏按“侧栏列子树内重定义 label/border token”实现，正文区不受影响。
